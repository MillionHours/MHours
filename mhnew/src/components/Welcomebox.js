    ...
    <div class="wrapper">
      ...
      <div class="team">
        <div className="team_member" >
          ...
          <NavLink className="nav-link active" style={{color:'black'}}aria-current="page" exact to="/Education2">More Info</NavLink>
        ...
        <div className="team_member">
          ...
          <img src={health} alt="img" className='fimage' id='secondimg' onMouseEnter={() => setIsShown1(true)} onMouseLeave={() => setIsShown1(false)}></img>
          ...
          <NavLink className="nav-link active" style={{color:'black'}} aria-current="page" exact to="/Health2">More Info</NavLink>
        ...
        <div class="team_member">
          ...
          <img src={Farming} alt="img" className='fimage' id='thirdimg' onMouseEnter={() => setIsShown2(true)} onMouseLeave={() => setIsShown2(false)}></img>
          ...
          <NavLink className="nav-link active"style={{color:'black'}} aria-current="page" exact to="/Agriculture2">More Info</NavLink>
        ...
        <div class="team_member">
          ...
          <img src={sustainability} alt="img" className='fimage' id='fourthdimg' onMouseEnter={() => setIsShown3(true)} onMouseLeave={() => setIsShown3(false)}></img>
          ...
          <NavLink className="nav-link active" style={{color:'black'}}aria-current="page" exact to="/Sustainability2">More Info</NavLink>
